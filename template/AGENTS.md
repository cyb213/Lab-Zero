...
- Skills: the ceremonies shipped in `.agents/skills/` — one directory per skill; each `SKILL.md`'s frontmatter says when to use it (that directory is the always-current list).
